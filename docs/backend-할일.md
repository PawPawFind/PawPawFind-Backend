...
> **현재 API·구조:** [docs/backend/](./backend/README.md)  
> 이 목록은 2026-08-15 기준 스냅샷이며, 상당수 항목은 이후 완료됐을 수 있다.

| 항목 | 내용 |
|------|------|
| 문서 버전 | 1.0 (레거시) |
| 관련 문서 | [backend/](./backend/README.md) · [기능 명세서](./backend-기능명세서.md) · [DB](./backend/database.md) |
| 기준일 | 2026-08-15 |
